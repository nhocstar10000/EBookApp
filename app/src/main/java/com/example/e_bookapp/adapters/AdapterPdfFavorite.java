...
import com.example.e_bookapp.databinding.RowPdfFavoriteBinding;
...
public class AdapterPdfFavorite extends RecyclerView.Adapter<AdapterPdfFavorite.HolderPdfFavorite> {
    ...
    public void onBindViewHolder(@NonNull HolderPdfFavorite holder, int position) {
        ...
        holder.removeFavBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MyAppication.removetoFavorite(context,model.getId());
            }
        });
        ...
        ref.child(bookId)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        String categoryId = ""+snapshot.child("catagoryId").getValue();
                        ...
                        MyAppication.loadPdfFromUrlSinglePage(""+bookUrl,""+bookTitle,holder.pdfView,holder.progressBar,null);
                        MyAppication.loadPdfSize(""+bookUrl,""+bookTitle,holder.sizeTv);
