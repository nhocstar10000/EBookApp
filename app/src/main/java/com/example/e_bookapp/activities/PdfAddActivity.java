...
import com.example.e_bookapp.databinding.ActivityPdfAddBinding;
...
public class PdfAddActivity extends AppCompatActivity {
    ...
    private void uploadPdfToStorage() {
        Log.d(TAG, "uploadPdfToStorage: updloading to storage");
        ...
        storageReference.putFile(pdfUri)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Log.d(TAG,"onFailure: PDF upload failure due to" + e.getMessage());
    ...
    private void uploadPdfInfotoDb(String uploadedPdfUrl, long timestamp) {
        Log.d(TAG, "uploadPdfToStorage: updloading Pdf info to firebase db");
        ...
        ref.child(""+timestamp)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(PdfAddActivity.this, "Faile to upload to db due to" + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
